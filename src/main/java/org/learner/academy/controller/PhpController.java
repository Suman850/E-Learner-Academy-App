 ...
 */
@WebServlet("/php-full-stack")
public class PhpController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Query q1 = sessionHb.createQuery("from Subject where class_id = 10003");
			@SuppressWarnings("unchecked")
			List<Subject> subList = (List<Subject>) q1.list();

			Query q2 = sessionHb.createQuery("from Student where class_id = 10003");
			@SuppressWarnings("unchecked")
